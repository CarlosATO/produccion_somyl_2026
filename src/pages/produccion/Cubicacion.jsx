...
// Lista completa de comunas de Chile para autocompletado
const COMUNAS_CHILE = [
  ...
  // Región de O'Higgins
  "Chimbarongo", "Chépica", "Codegua", "Coinco", "Coltauco", "Doñihue", "Graneros", "La Estrella", "Las Cabras", "Litueche", "Lolol", "Machalí", "Malloa", "Marchigüe", "Mostazal", "Nancagua", "Navidad", "Olivar", "Palmilla", "Paredones", "Peralillo", "Peumo", "Pichidegua", "Pichilemu", "Placilla", "Pumanque", "Quinta de Tilcoco", "Rancagua", "Rengo", "Requínoa", "San Fernando", "San Vicente", "Santa Cruz",
  // Región del Maule
...
function Cubicacion() {
  ...
  return (
    <div className="container-fluid py-3 px-4 bg-light min-vh-100 d-flex flex-column">
        ...
        <Row className="g-3 align-items-center">
            <Col md={4}>
                <InputGroup>
                    ...
                    <Form.Control placeholder="Filtrar Actividad..." value={filterActividad} onChange={(e) => setFilterActividad(e.target.value)} className="border-start-0 bg-light"/>
            ...
            <Col md={4}>
                <InputGroup>
                    ...
                    <Form.Control placeholder="Buscar Zona, HP, Comuna..." value={filterZona} onChange={(e) => setFilterZona(e.target.value)} className="border-start-0 bg-light"/>
      ...
      <div className="table-responsive shadow-sm bg-white rounded border flex-grow-1" style={{maxHeight: '70vh'}}>
        <Table bordered size="sm" className="mb-0 align-middle" style={{fontSize: '0.85rem'}}>
