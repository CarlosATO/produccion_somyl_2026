      ...
      <div className="flex-grow-1 bg-white border rounded-3 shadow-sm overflow-auto">
        <Table hover responsive className="mb-0 align-middle small" striped>
            <thead className="bg-light sticky-top">
                <tr>
                    <th className="ps-3 py-3 text-secondary">Fecha Fin</th>
                    <th className="py-3 text-secondary">ID</th>
                    <th className="py-3 text-secondary">Responsable</th>
                    <th className="py-3 text-secondary" style={{width: '30%'}}>Actividad (Resumen)</th>
                    <th className="py-3 text-secondary">Ubicación</th>
                    <th className="text-end py-3 text-secondary">Monto Total</th>
                    <th className="text-center py-3 text-secondary">Estado</th>
                    <th className="text-end pe-3 py-3 text-secondary">Acciones</th>
                </tr>
            </thead>
            <tbody>
                {filteredData.length === 0 ? (
                    ...
                    filteredData.map(task => {
                        ...
                        return (
                            <tr key={task.id}>
                                <td className="ps-3 text-muted font-monospace">
